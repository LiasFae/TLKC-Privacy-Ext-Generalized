...
if __name__ == '__main__':
    ...
    res = Results()
    orig_log = xes_import_factory.apply("BPI_Challenge_2012.xes")
    anonym_log = xes_import_factory.apply("xes_results/BPI_Challenge_2012_minutes_2_20_0.5_set_suppressed.xes")
